...
This code calculates overall grid access for households in PG&E and SCE
service territories, considering residential building sizes.
...
ACCESS We calculate the number of households with access based on grid
limits.
...
#Comparison of households access between 2019 and 2023 ICA data The
proportions of household access for capacity thresholds above 0kW,
1.5kW, and 10kW have been manually recorded in a CSV file named
'compar_access_2019_2023.csv'. The results corresponding to the year
2019 have been sourced from the paper published by Brockway et al.
