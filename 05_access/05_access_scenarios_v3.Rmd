...
VERSION 3 - ADDING MUD ACCESS FOR LAST PART OF CODE (GROUP BY IOU)
...
```{r}
 ...
 mutate(sc1_veh_load = tothh_Cpoly*LVL1_CHRG_PWR)%>%
  ...
  mutate(sc1_hhnoacc150_small = sc1_hhnoacc150_pct*tothh_small_Cpoly)%>%
  mutate(sc1_hhnoacc150_large = sc1_hhnoacc150_pct*tothh_large_Cpoly)%>%
  mutate(sc1_hhnoacc150_MUD = sc1_hhnoacc150_pct*tothh_MUD_Cpoly)%>%
  ...
  mutate(sc1_hhnoaccinf_small = sc1_hhnoaccinf_pct*tothh_small_Cpoly)%>%
  mutate(sc1_hhnoaccinf_large = sc1_hhnoaccinf_pct*tothh_large_Cpoly)%>%
  mutate(sc1_hhnoaccinf_MUD = sc1_hhnoaccinf_pct*tothh_MUD_Cpoly)
...
```{r}
 ...
 mutate(sc2_veh_load = tothh_Cpoly*LVL2_CHRG_PWR)%>%
  ...
  mutate(sc2_hhnoacc150_small = sc2_hhnoacc150_pct*tothh_small_Cpoly)%>%
  mutate(sc2_hhnoacc150_large = sc2_hhnoacc150_pct*tothh_large_Cpoly)%>%
  mutate(sc2_hhnoacc150_MUD = sc2_hhnoacc150_pct*tothh_MUD_Cpoly)%>%
  #households with no access - more than -150kW
  ...
  mutate(sc2_hhnoaccinf_small = sc2_hhnoaccinf_pct*tothh_small_Cpoly)%>%
  mutate(sc2_hhnoaccinf_large = sc2_hhnoaccinf_pct*tothh_large_Cpoly)%>%
  mutate(sc2_hhnoaccinf_MUD = sc2_hhnoaccinf_pct*tothh_MUD_Cpoly)
...
IOU_wacc_sc3 <- IOU_wacc %>%
  ...
  mutate(sc3_hhnoacc150_small = sc3_hhnoacc150_pct*tothh_small_Cpoly)%>%
  mutate(sc3_hhnoacc150_large = sc3_hhnoacc150_pct*tothh_large_Cpoly)%>%
  mutate(sc3_hhnoacc150_MUD = sc3_hhnoacc150_pct*tothh_MUD_Cpoly)%>%
  #households with no access - more than -150kW
  ...
  mutate(sc3_hhnoaccinf_small = sc3_hhnoaccinf_pct*tothh_small_Cpoly)%>%
  mutate(sc3_hhnoaccinf_large = sc3_hhnoaccinf_pct*tothh_large_Cpoly)%>%
  mutate(sc3_hhnoaccinf_MUD = sc3_hhnoaccinf_pct*tothh_MUD_Cpoly)
...
IOU_wacc_sc4 <- IOU_wacc %>%
  ...
  mutate(sc4_hhnoacc150_small = sc4_hhnoacc150_pct*tothh_small_Cpoly)%>%
  mutate(sc4_hhnoacc150_large = sc4_hhnoacc150_pct*tothh_large_Cpoly)%>%
  mutate(sc4_hhnoacc150_MUD = sc4_hhnoacc150_pct*tothh_MUD_Cpoly)%>%
  #households with no access - more than -150kW
  ...
  mutate(sc4_hhnoaccinf_small = sc4_hhnoaccinf_pct*tothh_small_Cpoly)%>%
  mutate(sc4_hhnoaccinf_large = sc4_hhnoaccinf_pct*tothh_large_Cpoly)%>%
  mutate(sc4_hhnoaccinf_MUD = sc4_hhnoaccinf_pct*tothh_MUD_Cpoly)
...
df_sc1_cty_hh <- select(IOU_wacc_sc1, GEOID, county, IOU, tothh_Cpoly, intersect(starts_with("tothh_"), ends_with("_Cpoly")), starts_with("sc1_hhwacc"), starts_with("sc1_hhnoacc")) %>%
  ...
  summarise(
            ...
            sc1_cty_noacc150_small_pct = sum(sc1_hhnoacc150_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc1_cty_noacc150_large_pct = sum(sc1_hhnoacc150_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc1_cty_noacc150_MUD_pct = sum(sc1_hhnoacc150_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE),
            ...
            sc1_cty_noaccinf_small_pct = sum(sc1_hhnoaccinf_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc1_cty_noaccinf_large_pct = sum(sc1_hhnoaccinf_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc1_cty_noaccinf_MUD_pct = sum(sc1_hhnoaccinf_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE))
...
df_sc2_cty_hh <- select(IOU_wacc_sc2, GEOID, county, IOU, tothh_Cpoly, intersect(starts_with("tothh_"), ends_with("_Cpoly")), starts_with("sc2_hhwacc"), starts_with("sc2_hhnoacc")) %>%
  ...
  summarise(
            ...
            sc2_cty_noacc150_small_pct = sum(sc2_hhnoacc150_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc2_cty_noacc150_large_pct = sum(sc2_hhnoacc150_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc2_cty_noacc150_MUD_pct = sum(sc2_hhnoacc150_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE),
            ...
            sc2_cty_noaccinf_small_pct = sum(sc2_hhnoaccinf_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc2_cty_noaccinf_large_pct = sum(sc2_hhnoaccinf_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc2_cty_noaccinf_MUD_pct = sum(sc2_hhnoaccinf_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE))
...
df_sc3_cty_hh <- select(IOU_wacc_sc3, GEOID, county, IOU, tothh_Cpoly, intersect(starts_with("tothh_"), ends_with("_Cpoly")), starts_with("sc3_hhwacc"), starts_with("sc3_hhnoacc")) %>%
  ...
  summarise(
            ...
            sc3_cty_noacc150_small_pct = sum(sc3_hhnoacc150_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc3_cty_noacc150_large_pct = sum(sc3_hhnoacc150_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc3_cty_noacc150_MUD_pct = sum(sc3_hhnoacc150_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE),
            ...
            sc3_cty_noaccinf_small_pct = sum(sc3_hhnoaccinf_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc3_cty_noaccinf_large_pct = sum(sc3_hhnoaccinf_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc3_cty_noaccinf_MUD_pct = sum(sc3_hhnoaccinf_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE))
...
df_sc4_cty_hh <- select(IOU_wacc_sc4, GEOID, county, IOU, tothh_Cpoly, intersect(starts_with("tothh_"), ends_with("_Cpoly")), starts_with("sc4_hhwacc"), starts_with("sc4_hhnoacc")) %>%
  ...
  summarise(
            ...
            sc4_cty_noacc150_small_pct = sum(sc4_hhnoacc150_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc4_cty_noacc150_large_pct = sum(sc4_hhnoacc150_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc4_cty_noacc150_MUD_pct = sum(sc4_hhnoacc150_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE),
            ...
            sc4_cty_noaccinf_small_pct = sum(sc4_hhnoaccinf_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc4_cty_noaccinf_large_pct = sum(sc4_hhnoaccinf_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc4_cty_noaccinf_MUD_pct = sum(sc4_hhnoaccinf_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE))
...
df_sc1_hh <- select(IOU_wacc_sc1, GEOID, county, IOU, tothh_Cpoly, intersect(starts_with("tothh_"), ends_with("_Cpoly")), starts_with("sc1_hhwacc"), starts_with("sc1_hhnoacc")) %>%
  ...
  summarise(
            ...
            sc1_noacc150_small_pct = sum(sc1_hhnoacc150_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc1_noacc150_large_pct = sum(sc1_hhnoacc150_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc1_noacc150_MUD_pct = sum(sc1_hhnoacc150_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE),
            ...
            sc1_noaccinf_small_pct = sum(sc1_hhnoaccinf_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc1_noaccinf_large_pct = sum(sc1_hhnoaccinf_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc1_noaccinf_MUD_pct = sum(sc1_hhnoaccinf_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE))
...
df_sc2_hh <- select(IOU_wacc_sc2, GEOID, county, IOU, tothh_Cpoly, intersect(starts_with("tothh_"), ends_with("_Cpoly")), starts_with("sc2_hhwacc"), starts_with("sc2_hhnoacc")) %>%
  ...
  summarise(
            ...
            sc2_noacc150_small_pct = sum(sc2_hhnoacc150_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc2_noacc150_large_pct = sum(sc2_hhnoacc150_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc2_noacc150_MUD_pct = sum(sc2_hhnoacc150_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE),
            ...
            sc2_noaccinf_small_pct = sum(sc2_hhnoaccinf_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc2_noaccinf_large_pct = sum(sc2_hhnoaccinf_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc2_noaccinf_MUD_pct = sum(sc2_hhnoaccinf_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE))
...
df_sc3_hh <- select(IOU_wacc_sc3, GEOID, county, IOU, tothh_Cpoly, intersect(starts_with("tothh_"), ends_with("_Cpoly")), starts_with("sc3_hhwacc"), starts_with("sc3_hhnoacc")) %>%
  ...
  summarise(
            ...
            sc3_noacc150_small_pct = sum(sc3_hhnoacc150_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc3_noacc150_large_pct = sum(sc3_hhnoacc150_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc3_noacc150_MUD_pct = sum(sc3_hhnoacc150_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE),
            ...
            sc3_noaccinf_small_pct = sum(sc3_hhnoaccinf_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc3_noaccinf_large_pct = sum(sc3_hhnoaccinf_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc3_noaccinf_MUD_pct = sum(sc3_hhnoaccinf_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE))
...
df_sc4_hh <- select(IOU_wacc_sc4, GEOID, county, IOU, tothh_Cpoly, intersect(starts_with("tothh_"), ends_with("_Cpoly")), starts_with("sc4_hhwacc"), starts_with("sc4_hhnoacc")) %>%
  ...
  summarise(
            ...
            sc4_noacc150_small_pct = sum(sc4_hhnoacc150_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc4_noacc150_large_pct = sum(sc4_hhnoacc150_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc4_noacc150_MUD_pct = sum(sc4_hhnoacc150_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE),
            ...
            sc4_noaccinf_small_pct = sum(sc4_hhnoaccinf_small, na.rm=TRUE)/sum(tothh_small_Cpoly, na.rm=TRUE),
            sc4_noaccinf_large_pct = sum(sc4_hhnoaccinf_large, na.rm=TRUE)/sum(tothh_large_Cpoly, na.rm=TRUE),
            sc4_noaccinf_MUD_pct = sum(sc4_hhnoaccinf_MUD, na.rm=TRUE)/sum(tothh_MUD_Cpoly, na.rm=TRUE))
...
ggsave("figures/scenarios/PGE_access_scenarios_access.png", plot_access, width = 6, height = 4)
print(plot_access)
```
```{r}
sc1_load = sum(IOU_wacc_sc1$sc1_veh_load, na.rm = TRUE)
sc2_load = sum(IOU_wacc_sc2$sc2_veh_load, na.rm = TRUE)
sc3_load = sum(IOU_wacc_sc3$sc3_veh_load, na.rm = TRUE)
sc4_load = sum(IOU_wacc_sc4$sc4_veh_load, na.rm = TRUE)

tot_veh = sum(IOU_wacc$totveh_Cpoly, na.rm = TRUE)
tot_hh = sum(IOU_wacc$tothh_Cpoly, na.rm = TRUE)

sc1_load_veh = sc1_load/tot_veh
sc1_load_hh = sc1_load/tot_hh

sc2_load_veh = sc2_load/tot_veh
sc2_load_hh = sc2_load/tot_hh

sc3_load_veh = sc3_load/tot_veh
sc3_load_hh = sc3_load/tot_hh

sc4_load_veh = sc4_load/tot_veh
sc4_load_hh = sc4_load/tot_hh
```
