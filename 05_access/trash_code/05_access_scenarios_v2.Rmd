...
VERSION 2 - Trying to optimise the code - code too long!
...
sc <- c("sc1", "sc2", "sc3", "sc4")
acc <- c("hhwacc", "hhnoacc150", "hhnoaccinf")
hou <- c("SU", "duplex", "small", "large", "MUD")
df <- expand.grid(Scenario = sc, Access = acc, Housing = hou)
