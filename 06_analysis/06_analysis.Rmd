...
This file analyzes the relationships between different demographic features and hosting capacity
...
```{r}
for (i in 1:35){ #from 1 to 31: normal features // from 32 to 35: extra housing features
