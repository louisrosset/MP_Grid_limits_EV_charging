...
ggsave("demo_ces_all_pollution.png", c1, path="figures/lowesscomb/", width=8, height=6.5)
...
```{r}
plot_grid(b1, b2, c1, c2, d1, d2, nrow=3, ncol=2, scale=0.95, labels=c('a','b','c','d','e','f'), label_size=12)
...
ggsave("demo_housing_types_v1.png", e, path="figures/lowesscomb/", width=8, height=6.5)
...
ggsave("demo_housing_types_v2.png", e, path="figures/lowesscomb/", width=10, height=6.5)
