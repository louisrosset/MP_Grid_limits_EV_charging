...
-----------------------
Estimated percent change in the number of people between the periods of 2012-2016 and 2017-2021.
```{r}
# POPULATION CHANGE
ACS_2021_bg_popvar = read.csv("Population/ACS_2021_bg_popvar.csv", header=T, sep = ",", na.strings="null", colClasses=c(rep("character",10)))
colnames(ACS_2021_bg_popvar) <- c("Blockgroup", "GEOID", "State", "GEOID10", "GEOID_form", "popvar", "TimeFrame", "Year", "Source", "Location")
ACS_2021_bg_popvar <- ACS_2021_bg_popvar[, c("GEOID10", "popvar")]
ACS_2021_bg_popvar[,"popvar"] <- as.numeric(ACS_2021_bg_popvar[,"popvar"])

ACS_2021_bg_popvar$GEOID10 <- substring(ACS_2021_bg_popvar$GEOID10, 2)
```
...
bg_demo <- bg_demo %>% # HOUSEHOLD-LEVEL METRICS, tothh from income data
  ...
  merge(ACS_2021_bg_popvar[, c("GEOID10", "popvar")], by= "GEOID10", all.x=TRUE) # Population change
```
